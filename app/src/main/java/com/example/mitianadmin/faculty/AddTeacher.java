...
import com.example.mitianadmin.NoticeData;
import com.example.mitianadmin.UploadNotice;
...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{ "Select Category","Computer Science(CSE)","Mechanical","ETC","Agriculture"};
